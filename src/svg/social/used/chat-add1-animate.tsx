...
export default function ChatAdd1Animate({drawerAnimate,setDetails}:eachSVGType){
...
export default function ChatAddAnimate(){
    const [animationValue, setAnimationValue] = React.useState({
        pathLength: 1,
        scale: 1
    })
...
const styles = StyleSheet.create({
    ...
    <path d="M85.3334 213.333H341.333" stroke="black" stroke-width="20" stroke-linecap="round" stroke-linejoin="round"/>
