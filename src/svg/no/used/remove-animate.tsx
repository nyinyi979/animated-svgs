...
export default function RemoveAnimate({drawerAnimate,setDetails}:eachSVGType){
...
export default function RemoveAnimate(){
    const [animationValue, setAnimationValue] = React.useState({
        pathLength: 1,
        scale: 1
    })
        ...
        >
            ...
            >
                ...
                <motion.path 
                    ...
                    d="M320 512H704" stroke="black" strokeWidth="20"/>
            </motion.svg>
        </div>
    )
}`,
