...
export default function DirectionAnimate({drawerAnimate,setDetails}:eachSVGType){
...
export default function DirectionAnimate(){
    ...
    const animate = () =>{
        animationValue.value = {scale:1,strokeDasharray:1800,strokeDashoffset:1800}
        animationValue.value = withSequence(
            withTiming({scale:1.1,strokeDasharray:1800,strokeDashoffset:1}),
            withTiming({scale:1.1,strokeDasharray:1800,strokeDashoffset:0})
        );
    }
    const inanimate = () =>{
        animationValue.value = withTiming(
            {scale:1,strokeDasharray:1800,strokeDashoffset:1},
