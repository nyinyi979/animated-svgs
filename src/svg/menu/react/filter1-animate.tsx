...
export default function Filter1Animate(){
    ...
    return(
        ...
        >
            ...
            >
                <ellipse cx="298.667" cy="298.667" rx="128" ry="128" transform="rotate(90 298.667 298.667)" stroke="black" strokeWidth="20" strokeLinecap="round"/>
                <path d="M405.333 213.333H849.333C851.219 213.333 852.161 213.333 852.747 213.919C853.333 214.505 853.333 215.447 853.333 217.333V380C853.333 381.885 853.333 382.828 852.747 383.414C852.161 384 851.219 384 849.333 384H405.333" stroke="black" strokeWidth="20" strokeLinecap="round"/>
