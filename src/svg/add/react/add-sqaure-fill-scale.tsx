...
export default function AddSquareFill_Scale(){
    ...
    return(
        ...
        >
            <motion.svg initial={{scale:1}} animate={{scale:scale}} viewBox="0 0 1024 1024" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <path d="M512 256L512 768" stroke="white" strokeWidth="20" strokeLinecap="square"/>
                <path d="M256 512L768 512" stroke="white" strokeWidth="20" strokeLinecap="square"/>
            </motion.svg>
        </div>
