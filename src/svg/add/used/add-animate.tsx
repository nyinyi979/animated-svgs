...
export default function AddAnimate({drawerAnimate,setDetails}:eachSVGType){
...
const styles = StyleSheet.create({
    ...
    <path d="M512 256L512 768" stroke="black" stroke-width="20" stroke-linecap="round"/>
    <path d="M256 512L768 512" stroke="black" stroke-width="20" stroke-linecap="round"/>
</svg>
`
        })
        drawerAnimate();
