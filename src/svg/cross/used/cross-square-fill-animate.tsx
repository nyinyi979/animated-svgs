...
export default function CrossSquareFillAnimate({drawerAnimate,setDetails}:eachSVGType){
        ...
        >
            ...
            >
                ...
                <AnimatedPath
                    ...
                    d="M682.667 341.333L341.333 682.667" stroke="white" strokeWidth="20" />
                <AnimatedPath
                    animatedProps={pathAnimatedProps}
                    d="M341.333 341.333L682.667 682.667" stroke="white" strokeWidth="20" />
            </AnimatedSvg>
        </View>
    )
}
