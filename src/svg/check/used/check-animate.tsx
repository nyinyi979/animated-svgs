...
export default function CheckAnimate({drawerAnimate,setDetails}:eachSVGType){
...
const styles = StyleSheet.create({
    ...
    <path d="M341.338 554.669L553.899 724.717C554.327 725.06 554.95 724.994 555.297 724.57L938.671 256.002" stroke="black" stroke-width="20" stroke-linecap="round"/>
</svg>
`
        })
        drawerAnimate();
