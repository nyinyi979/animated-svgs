...
export default function CheckRingFillAnimate({drawerAnimate,setDetails}:eachSVGType){
    ...
    const openDrawer = () =>{
        setDetails({
            name:"Check ring fill",
            react:`import React from "react";
import { motion } from "framer-motion";
export default function CheckRingFillAnimate(){
    const [animationValue, setAnimationValue] = React.useState({
        path: 1,
        scale: 1
    })
...
const styles = StyleSheet.create({
    ...
    <circle cx="512" cy="512" r="384" fill="black"/>
    <path d="M341.333 512L469.333 640L682.667 384" stroke="white" stroke-width="20"/>
</svg>
`
        })
        drawerAnimate();
