...
export default function FolderAnimate({drawerAnimate,setDetails}:eachSVGType){
...
const styles = StyleSheet.create({
    ...
    <path d="M192 490.667H832" stroke="black" stroke-width="20" stroke-miterlimit="1.41421"/>
