...
export default function DoubleLRightAnimate({drawerAnimate,setDetails}:eachSVGType){
...
const styles = StyleSheet.create({
    ...
    <path d="M85.3333 426.667H597.333V256.435C597.333 256.264 597.534 256.172 597.663 256.283L896 512L597.663 767.717C597.534 767.828 597.333 767.736 597.333 767.565V597.333H85.3333" stroke="black" stroke-width="20"/>
</svg>
`
        })
        drawerAnimate();
