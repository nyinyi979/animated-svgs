...
export default function RightDoubleAnimate({drawerAnimate,setDetails}:eachSVGType){
...
export default function RightDoubleAnimate(){
    const [animationValue, setAnimationValue] = React.useState({
        translateX: [0],
        scale: 1
    })
        ...
        >
            ...
            >
                <motion.path 
                    ...
                    d="M512 768L768 512L512 256" stroke="black" strokeWidth="20"/>
                <motion.path 
                    initial={{translateX:0}}
                    animate={{translateX:animationValue.translateX}}
                    d="M256 768L512 512L256 256" stroke="black" strokeWidth="20"/>
            </motion.svg>
        </div>
    )
}`,
